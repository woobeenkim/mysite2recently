...
<% List<PersonVo> PL = (List<PersonVo>)request.getAttribute("pl");  %>
			...
			<div id="guestbook">
				...
				<table class="guestRead">
					...
					<tr>
						...
						<td><a href="/mysite2/gbc?action=dform&no=<%=pv.getNo()%>">[삭제]</a></td>
					</tr>
					<tr>
						<td colspan=4 class="text-left"><%=pv.getContent() %></td>
					</tr>
				</table>
				<%} %>
				<!-- //guestRead -->
